  ...
  .run(function($state){
	...
	mainApp.controller('blogController',function($scope,$state,Blog){
        $scope.title = 'Angular + Blogger';
        $scope.description = 'An AngularJS blog template interfacing with the Blogger API';
	...
	mainApp.factory('Blog',function($resource){
    	return $resource(
    		'https://www.googleapis.com/blogger/v3/blogs/8686106352502303722/posts?&key=AIzaSyDybArURpn7j35Dm6af-M6x8OVCMDBU4_4',
    		{},
